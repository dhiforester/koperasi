<?php
    ...
    if(empty($_POST['id_akses_anggota'])){
        ...
        if(empty($DataDetailAkses['email'])){
            ...
            if(empty($_POST['old_password'])){
                ...
                $Qry=mysqli_query($Conn,"SELECT*FROM akses_anggota WHERE email='$email' AND password='$old_password'")or die(mysqli_error($Conn));
                        ...
                        if($_POST['password1']!==$_POST['password2']){
                            ...
                            if($JumlahKarakterPassword>20||$JumlahKarakterPassword<6||!preg_match("/^[a-zA-Z0-9]*$/", $_POST['password1'])){
                                ...
                                if($UpdateAkses){
                                    ...
                                    echo '<small class="text-success" id="NotifikasiEditPasswordAnggotaBerhasil">Success</small>';
                                }else{
