<form action="javascript:void(0);" id="ProsesEditPasswordAnggota">
    <div class="card mt-5">
        <div class="card-header">
            <div class="row">
                <div class="col-md-10">
                    <h4>Ganti Password Anggota</h4>
                </div>
                <div class="col-md-2">
        ...
        <div class="card-body">
            <input type="hidden" name="id_akses_anggota" id="id_akses_anggota" value="<?php echo "$SessionIdAksesAnggota"; ?>">
            <div class="row mt-3">
                <div class="col-md-3">
            ...
            <div class="row mt-3">
                ...
                <div class="col-md-9">
                    ...
                    <div id="NotifikasiEditPasswordAnggota">
