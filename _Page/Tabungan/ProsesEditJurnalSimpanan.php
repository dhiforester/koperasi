                    ...
                    if(empty($_POST['nilai'])){
                        ...
                        if(!preg_match("/^[0-9]*$/", $nilai)){
                            ...
                            if($UpdateJurnal){
                                ...
                                $KeteranganLog="Edit Jurnal Simpanan Berhasil";
                                include "../../_Config/InputLog.php";
                                $_SESSION ["NotifikasiSwal"]="Edit Jurnal Berhasil";
                                echo '<small class="text-success" id="NotifikasiEditJurnalSimpananBerhasil">Success</small>';
                            }else{
