    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <form action="index.php?Page=RekapitulasiTransaksi&Sub=Transaksi" method="POST" id="ProsesTampilkanGrapikTransaksi">
                    <div class="row">
                        <div class="col-md-2">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-12">
                        <div id="GrafikRekapitulasiTransaksi">
                            ...
                            <tbody>
                                <?php
                                    ...
                                    for ( $i =$a; $i<=$b; $i++ ){
                                        ...
                                        echo '      <a href="_Page/RekapitulasiTransaksi/CetakUraianTransaksi.php?kategori='.$KategoriTransaksi.'&status='.$StatusStransaksi.'&periode='.$WaktuPencarian.'" target="_blank" class="btn btn-sm btn-success">';
                                        echo '          View';
                                        echo '      </a>';
                                        echo '  </td>';
                                        echo '</tr>';
            ...
            <div class="card-footer">
                <div class="row">
                    <div class="col-md-12">
                        <a href="_Page/RekapitulasiTransaksi/CetakRekapTransaksi.php?kategori=<?php echo "$KategoriTransaksi"; ?>&status=<?php echo "$StatusStransaksi"; ?>&Periode=<?php echo "$Periode"; ?>&Tahun=<?php echo "$Tahun"; ?>&Bulan=<?php echo "$Bulan"; ?>&Format=HTML" target="_blank" class="btn btn-sm btn-outline-info">
                            HTML
                        </a>
                        <a href="_Page/RekapitulasiTransaksi/CetakRekapTransaksi.php?kategori=<?php echo "$KategoriTransaksi"; ?>&status=<?php echo "$StatusStransaksi"; ?>&Periode=<?php echo "$Periode"; ?>&Tahun=<?php echo "$Tahun"; ?>&Bulan=<?php echo "$Bulan"; ?>&Format=Excel" target="_blank" class="btn btn-sm btn-outline-success">
                            Excel
                        </a>
                    </div>
                </div>
