<?php
    ...
    $Sum = mysqli_fetch_array(mysqli_query($Conn, "SELECT SUM(jumlah) AS jumlah FROM transaksi_rincian WHERE id_akses='$SessionIdAkses' AND id_transaksi='$id_transaksi'"));
...
<div class="row">
    <div class="col-md-12 mb-2">
        ...
        <input type="number" readonly name="subtotal" id="GetSubtotal" class="form-control"  value="<?php echo "$jumlah_transaksi"; ?>">
    </div>
</div>
<div class="row">
    <div class="col-md-6 mb-2">
        <label for="ppn_persen"> (%) PPN</label>
        <input type="text" name="ppn_persen" id="GetPpnPersen" class="form-control" value="<?php echo $ppn_set_persen;?>">
    </div>
    <div class="col-md-6 mb-2">
        <label for="ppn_rp"> (Rp) PPN</label>
        <input type="text" name="ppn_rp" id="GetPpnRp" class="form-control" value="<?php echo $ppn_rp;?>">
    </div>
</div>
<div class="row">
    <div class="col-md-12 mb-3">
        <div class="form-check form-switch"> 
            <input class="form-check-input" <?php if($ppn=="Yes"){echo "checked";} ?> type="checkbox" name="SettingPpn" id="flexSwitchCheckDefault" value="Yes"> 
            <label class="form-check-label" for="flexSwitchCheckDefault">Aktivkan PPN Untuk Setiap Transaksi</label>
        </div>
    </div>
</div>
<div class="row">
    <div class="col-md-12" id="NotifikasiTambahPpn">
