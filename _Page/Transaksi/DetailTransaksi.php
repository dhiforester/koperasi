                ...
                <div class="card">
                    ...
                    <div class="card-footer">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="btn-group">
                                    <a href="index.php?Page=Transaksi&Sub=EditTransaksi&id=<?php echo "$id_transaksi";?>" class="btn btn-sm btn-outline-info">
                                        <i class="bi bi-pencil-square"></i> Edit
                                    </a>
                                    <a href="_Page/CetakInvoice/CetakInvoiceByTransaksi.php?id_transaksi=<?php echo "$id_transaksi";?>" target="_blank" class="btn btn-sm btn-outline-info">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                <button type="button" class="btn btn-sm btn-primary btn-block" data-bs-toggle="modal" data-bs-target="#ModalTambahRincian" data-id="<?php echo "$id_transaksi";?>">
                                    <i class="bi bi-plus"></i> Barang
                                </button>
                            </div>
                            <div class="col-md-2">
                                <button type="button" class="btn btn-sm btn-primary btn-block" data-bs-toggle="modal" data-bs-target="#ModalTambahRincianLainnya" data-id="<?php echo "$id_transaksi";?>">
                                    <i class="bi bi-plus"></i> Lainnya
                                </button>
                            </div>
                            <div class="col-md-2">
                                <button type="button" class="btn btn-sm btn-primary btn-block" data-bs-toggle="modal" data-bs-target="#ModalTambahPpnEdit" data-id="<?php echo "$id_transaksi";?>">
                                    <i class="bi bi-pencil"></i> PPN
                                </button>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <a href="javascript:void(0);" class="btn btn-sm btn-block btn-primary" data-bs-toggle="modal" data-bs-target="#ModalTambahPembayaran" data-id="<?php echo "$id_transaksi";?>">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-12" id="MenampilkanTabelPembayaran">
                    ...
                    <div class="card-footer">
                        <div class="row">
                            <div class="col-md-3">
                                <button type="button" class="btn btn-sm btn-danger btn-block" data-bs-toggle="modal" data-bs-target="#ModalHapusSemuaPembayaran" data-id="<?php echo "$id_transaksi";?>" title="Hapus Semua Data Pembayaran">
                                    <i class="bi bi-x"></i> Hapus Pembayaran
                                </button>
                            </div>
                        </div>
                    </div>
